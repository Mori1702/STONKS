...
# WICHTIG FÜR RENDER: Datenbank sofort erstellen!
init_db()
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    <h5>Aktie hinzufügen</h5>
                    <form action="/add_stock" method="POST">
                        <div class="input-group">
                            <input type="text" name="ticker" class="form-control" placeholder="z.B. AAPL" required>
...
def lookup():
    ...
    html = BASE_TEMPLATE.replace('{% block content %}{% endblock %}', '''
    <a href="/" class="btn btn-secondary mb-3">&larr; Zurück zum Dashboard</a>
